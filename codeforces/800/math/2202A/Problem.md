...
Today, Alex wants to build a parkour course for Steve to train his parkour skills on. A parkour course is a sequence p0→p1→…→pk of integer coordinates on the plane. Here, a contiguous pair of coordinates is called a move, denoted as pi−1→pi.
...
The only line of each test case contains two integers x and y (1≤x≤109, −108≤y≤108).
